...
heatmap_folder = 'mnist/heatmap-ssim-80'
m_type = 'non-optimal'
            ...
            if os.path.exists(m_path):
                ...
                for m_png in m_pngs:
                    ...
                    if save_to_heatmap_folder:
                      heatmap_path = os.path.join(heatmap_folder, f'heatmap-{folder}-{subfolder}.png')
                    else:
                    ...
                    if not os.path.exists(heatmap_path):
                      ...
                      if ssim_distance > 0.8:
                        ...
                        axs[2].set_title(f'Difference Heatmap - L2: {int(get_distance(image, m_image))}, SSIM: {round(ssim_distance * 100, 3)}')
